...
public class CTA051 {
	...
	/*
	 * CTA051 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação antes de limpar os campos 
	 * preenchendo todos os campos e acionando o botão Limpar declinando a mensagem.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA051 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação antes de limpar os campos" + 
				" preenchendo todos os campos e acionando o botão Limpar declinando a mensagem.");
