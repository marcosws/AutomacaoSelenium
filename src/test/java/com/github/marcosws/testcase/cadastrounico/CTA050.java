...
public class CTA050 {
	...
	public void startApplication() {
		...
		Log.title("CTA050 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação antes de limpar os campos" + 
				" preenchendo todos os campos e acionando o botão Limpar aceitando a mensagem.");
