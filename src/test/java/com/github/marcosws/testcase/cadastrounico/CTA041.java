...
public class CTA041 {
	...
	/*
	 * CTA041 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa 
	 * e omitindo o preenchimento do campo Razão Social e preenchendo demais campos com dados válidos.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA041 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa" + 
				" e omitindo o preenchimento do campo Razão Social e preenchendo demais campos com dados válidos.");
