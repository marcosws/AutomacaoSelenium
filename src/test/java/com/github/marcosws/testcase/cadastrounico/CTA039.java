...
public class CTA039 {
	...
	/*
	 * CTA039 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa 
	 * e preenchendo todos os campos com dados válidos.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA039 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa" + 
				" e preenchendo todos os campos com dados válidos.");
