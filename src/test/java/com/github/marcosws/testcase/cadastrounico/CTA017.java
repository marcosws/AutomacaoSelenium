...
public class CTA017 {
	...
	/*
	 * CTA017 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e 
	...
	public void startApplication() {
		...
		Log.title("CTA017 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e" + 
				" omitindo o preenchimento do campo Telefone e preenchendo demais campos com dados válidos.");
