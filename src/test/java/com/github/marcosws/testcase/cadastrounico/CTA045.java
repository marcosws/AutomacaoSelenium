...
public class CTA045 {
	...
	/*
	 * CTA045 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa 
	 * e omitindo o preenchimento do campo Celular, Telefone e preenchendo demais campos com dados válidos.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA045 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa" + 
				" e omitindo o preenchimento do campo Celular, Telefone e preenchendo demais campos com dados válidos.");
