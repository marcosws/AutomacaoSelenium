...
public class CTA012 {
	...
	/*
	 CTA012 - Realizar o cadastro de cliente para pessoa física sem parametrização (Apresentar caixa de dialogo) 
	...
	public void startApplication() {
		...
		Log.title("CTA012 - Realizar o cadastro de cliente para pessoa física sem parametrização (Apresentar caixa de dialogo)" + 
				" omitindo o preenchimento de todos os campos.");
