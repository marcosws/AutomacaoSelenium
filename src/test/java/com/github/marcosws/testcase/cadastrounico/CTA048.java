...
public class CTA048 {
	...
	/*
	 * CTA048 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação de Cadastro, 
	...
	public void startApplication() {
		...
		Log.title("CTA048 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação de Cadastro," + 
				" aceitando a mensagem e preenchendo todos os campos com dados válidos.");
