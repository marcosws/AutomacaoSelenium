...
public class CTA019 {
	...
	/*
	 * CTA019 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e 
	...
	public void startApplication() {
		...
		Log.title("CTA019 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e" + 
				" omitindo o preenchimento do campo E-mail e preenchendo demais campos com dados válidos.");
