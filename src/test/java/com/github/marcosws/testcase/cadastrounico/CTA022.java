...
public class CTA022 {
	...
	/*
	 CTA022 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e 
	...
	public void startApplication() {
		...
		Log.title("CTA022 - Realizar o cadastro de cliente para pessoa física com parametrização selecionando Apresentar label informativa e" + 
				" preenchendo com um Formato de Celular inválido e preenchendo demais campos com dados válidos.");
