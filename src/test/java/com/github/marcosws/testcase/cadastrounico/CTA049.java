...
public class CTA049 {
	...
	/*
	 * CTA049 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação de Cadastro, 
	 * declinando o mensagem e preenchendo todos os campos com dados válidos.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA049 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar mensagem de confirmação de Cadastro, " + 
				" declinando o mensagem e preenchendo todos os campos com dados válidos.");
