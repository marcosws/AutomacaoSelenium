...
public class CTA044 {
	...
	/*
	 * CTA044 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa 
	 * e omitindo o preenchimento do campo Celular, E-Mail e preenchendo demais campos com dados válidos.
	 */
	...
	public void startApplication() {
		...
		Log.title("CTA044 - Realizar o cadastro de cliente para pessoa jurídica com parametrização selecionando Apresentar label informativa" + 
				" e omitindo o preenchimento do campo Celular, E-Mail e preenchendo demais campos com dados válidos.");
